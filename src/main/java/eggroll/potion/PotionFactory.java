...
public class PotionFactory {
    ...
    private static final List<PotionData> COMMON = List.of(
            ...
            new PotionData("potion_fullness_common", "Fullness Potion", "🍵", "Boosts fullness", PetStatType.FULLNESS, 1),
    ...
    private static final List<PotionData> RARE = List.of(
            ...
            new PotionData("potion_fullness_rare", "Elixir of Fullness", "🧡", "Greatly boosts fullness", PetStatType.FULLNESS, 3),
    ...
    private static final List<PotionData> EPIC = List.of(
            ...
            new PotionData("potion_fullness_epic", "Essence of Abundance", "🏆", "Massively boosts fullness", PetStatType.FULLNESS, 5),
